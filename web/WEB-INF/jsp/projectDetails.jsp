...
<div class="row">
	...
	<c:param name="projectId" value="${command.projectId}"/></c:url>">Edit</a>
					...
					<a class="btn"
						href="<c:url value="/archiveProject.htm">
	<c:param name="projectId" value="${command.projectId}"/></c:url>">
						Archive</a> <a class="btn"
						href="<c:url value="/deleteProject.htm">
	<c:param name="projectId" value="${command.projectId}"/></c:url>"
	 ...
	 Read the warning carefully before you confirm!')) ">Delete</a>
		...
		<font color="red">Warning:</font> Delete this project will also delete all the results related to this project. Please
...
<div class="row">
	<div class="span6">
		...
		<c:param name="projectId" value="${command.projectId}"/></c:url>">
			...
			href="<c:url value="/exportResults.htm">
		<c:param name="projectId" value="${command.projectId}"/></c:url>"> <b>Export
				Results</b></a>
